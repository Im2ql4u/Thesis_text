...
variational representation even where the total energy cannot tell two networks apart---under
the parametrisations used here the correlator concentrates its tangent weight on fewer and
more interpretable directions, and the message-passing backflow avoids a rank collapse that
overtakes a smaller conventional one. Architecture, optimiser and sampling measure then meet
...
observed shell geometry carries a Markov-chain-free cascade of converged states to
$\omega=0.0035$, where a transfer instability in the Slater--Jastrow balance takes over.
