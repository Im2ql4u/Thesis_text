...
angles, $\Phi_n$ is a two-dimensional random walk of $n$ unit steps, so
$\langle|\Phi_n|\rangle=\sqrt\pi/(2\sqrt n)\approx0.886/\sqrt n$ and
$\langle|\Phi_n|^2\rangle=1/n$. A five-particle ring with no angular order whatever returns
$|\Phi_5|\approx0.40$. We therefore report $|\Phi_n|$ together with its ratio to this null
